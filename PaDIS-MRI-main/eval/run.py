...
def parse_args():
    ...
    p.add_argument("--image_size", type=int, nargs=2, default=[246, 384])
    # p.add_argument("--pad", type=int, default=64)
    p.add_argument("--pad_y", type=int, default=None)
    p.add_argument("--pad_x", type=int, default=None)
...
def main():
    ...
    args.pad = (int(args.pad_y), int(args.pad_x))

...
def _src_to_module(src):
    ...
    if module is None:
        ...
        ###
        module.__dict__.setdefault("__file__", module_name + ".py")
        module.__dict__.setdefault("__package__", "")
        ###
        ...
        exec(compile(src, module.__dict__["__file__"], "exec"), module.__dict__)

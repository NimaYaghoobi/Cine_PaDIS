...
@click.option('--pad_y', help='Zero padding height (top/bottom)', metavar='INT', type=int, required=True)
@click.option('--pad_x', help='Zero padding width (left/right)',  metavar='INT', type=int, required=True)
@click.option('--t_patch', help='Temporal patch length Lt (frames per temporal patch)', metavar='INT', type=int, required=True)
...
def main(**kwargs):
    ...
    c.pad_y = opts.pad_y
    c.pad_x = opts.pad_x
    c.loss_kwargs.t_patch = opts.t_patch
